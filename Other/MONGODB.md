...
```
复制db的路径，并通过mongod  --dbpath指定数据库目录，启动mongdb服务
```
[root@localhost mongodb-linux-i686-3.0.6]# mongod --dbpath=/home/itcast/mongodb-linux-i686-3.0.6/data/db
```
如果数据库目录是/data/db，可以直接在目录下使用 ./mongod启动服务
```
